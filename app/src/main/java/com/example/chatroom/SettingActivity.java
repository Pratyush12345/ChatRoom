...
public class SettingActivity extends AppCompatActivity {
    ...
    private Button mChaneStatus;
    private static final int IMAGE_REQUEST_CODE=1;
    private StorageReference mProfileStorage;
    private ProgressDialog mProgress;
    private String dowload_uri,thumb_url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDispName=findViewById(R.id.setting_display_name);
        mStatus=findViewById(R.id.setting_status_text);
        mChaneStatus=findViewById(R.id.setting_status_btn);
        mChangeImage=findViewById(R.id.setting_image_btn);
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")) {
                    //Picasso.with(SettingActivity.this).load(image).placeholder(R.drawable.default_image).into(mCircleImageView);
        ...
        mChaneStatus.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference filePath=mProfileStorage.child("profile_images").child(mCurrentUser.getUid()+".jpg");
                final StorageReference thumb_filepath2=mProfileStorage.child("profile_images").child("thumbs").child(mCurrentUser.getUid()+".jpg");
                        ...
                        if(task.isSuccessful()){
                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Log.d("downloadUrl",dowload_uri);

                                }
                            });

                            UploadTask uploadTask=thumb_filepath2.putBytes(thumb_byte);
                                    ...
                                    if(thumb_task.isSuccessful()){
                                        thumb_filepath2.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onSuccess(Uri uri) {
                                                ...
                                                Log.d("thumbUrl",thumb_url);
                                                Map update_hashMap=new HashMap<>();
                                                update_hashMap.put("image",dowload_uri);
                                        ...
                                        Toast.makeText(SettingActivity.this,"Error in thumb_image",Toast.LENGTH_LONG).show();
                                        mProgress.dismiss();
                                    }
                                }
                            });
